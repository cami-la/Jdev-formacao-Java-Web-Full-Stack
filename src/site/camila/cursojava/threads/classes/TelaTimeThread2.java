...
public class TelaTimeThread2 extends JDialog {
	/** atributos:
	1 janela
	2 campos de texto (Nome e e-mail)
	2 label (para nome e e-mail)
	2 botões (add e stop)
	*/
	...
	public TelaTimeThread2() {
		...
		jpanel.add(labelNome, gridBagConstraints); //adicionando a label (nome) na janela (jpanel) de acordo com as definições do grid (gridBagConstraints)
		...
		gridBagConstraints.gridx++; //pula um grid, como foi redefinido (gridwidth), agora cada atributo ocupa apenas 1 grid.
		...
		buttonAdd.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				ObjetoFilaThread filaThread = new ObjetoFilaThread(); //objeto que será adicionado na lista assim que apertar-mos o botão add
				filaThread.setNome(textNome.getText()); //colocando o nome que veio do campo (textNome) dentro do objeto (filaThread)
				filaThread.setEmail(textEmail.getText()); //colocando o e-mail que veio do campo (textEmail) dentro do objeto (filaThread)
